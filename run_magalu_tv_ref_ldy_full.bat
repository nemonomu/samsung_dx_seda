...
REM anti-crash: disable count-based recycle (recycle -> navigation -> DrissionPage
REM crash), stretch age, and shorten graphql timeout for fast self-recovery
...
:failed_tv
call :log "[SEDA] Magalu TV full run failed"
exit /b 1

:failed_ref
call :log "[SEDA] Magalu REF full run failed"
exit /b 1
