...
if not defined SEDA_MAGALU_LISTING_ZENROWS_RETRIES set SEDA_MAGALU_LISTING_ZENROWS_RETRIES=1
if not defined SEDA_MAGALU_LISTING_ZENROWS_RETRY_SLEEP_SECONDS set SEDA_MAGALU_LISTING_ZENROWS_RETRY_SLEEP_SECONDS=2
