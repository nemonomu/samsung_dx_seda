...
set "SEDA_RUN_ROOT=%~dp0seda\data\magalu\listing_production_smoke\tv\%SEDA_RUN_TIMESTAMP%"
set "SEDA_RUN_LOG_FILE=%~dp0seda\magalu\log\magalu_tv_listing_production_smoke_%SEDA_RUN_TIMESTAMP%.log"
...
rem Exercise the actual production GraphQL-first order with an isolated browser profile.
set "SEDA_MAGALU_LISTING_FETCH_MODE=magalu_listing_graphql_zenrows"
set "SEDA_MAGALU_BROWSER_USE_SYSTEM_PROFILE=0"
set "SEDA_MAGALU_BROWSER_ADDRESS="
set "SEDA_MAGALU_BROWSER_LOCAL_PORT="
set "SEDA_MAGALU_BROWSER_PROFILE=C:/tmp/seda_magalu_profiles/listing_production_smoke_%SEDA_RUN_TIMESTAMP%"
set "SEDA_MAGALU_BROWSER_CLOSE_ON_EXIT=1"
set "SEDA_MAGALU_SEARCH_BROWSER_READY_TIMEOUT=10"
set "SEDA_MAGALU_SEARCH_BROWSER_HTML_ATTEMPTS=3"
set "SEDA_MAGALU_SEARCH_BROWSER_POLL_SECONDS=0.5"
set "SEDA_MAGALU_BROWSER_SEARCH_RECYCLE_ATTEMPTS=1"
...
call :log "[SEDA] Magalu TV listing production smoke started"
...
call python -m seda.magalu.listing_smoke_check --transport production --run-root "%SEDA_RUN_ROOT%"
...
call :log "[SEDA] Magalu TV listing production smoke passed"
exit /b 0
...
:failed
call :log "[SEDA] Magalu TV listing production smoke failed"
exit /b 1
