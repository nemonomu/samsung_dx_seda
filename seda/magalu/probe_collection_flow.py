...
def main():
    ...
    summary = {
        ...
        "environment": {
            ...
            "browser_address": os.getenv("SEDA_MAGALU_BROWSER_ADDRESS", ""),
            "browser_local_port": os.getenv("SEDA_MAGALU_BROWSER_LOCAL_PORT", ""),
            "browser_profile": os.getenv("SEDA_MAGALU_BROWSER_PROFILE", ""),
            "browser_use_system_profile": os.getenv("SEDA_MAGALU_BROWSER_USE_SYSTEM_PROFILE", ""),
