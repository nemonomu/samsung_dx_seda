...
if not defined SEDA_MAGALU_BROWSER_PROFILE set "SEDA_MAGALU_BROWSER_PROFILE=C:/tmp/seda_magalu_profiles/run_magalu_tv_ref_ldy_drission_%SEDA_RUN_TIMESTAMP%"
