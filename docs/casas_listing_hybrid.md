...
> This document describes retained listing mode 2. The current default is mode 3 (UC + API); see `casas_listing_modes.md` for selection and scope. Detail routing is unchanged.
